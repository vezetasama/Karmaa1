...
const products = [
  {
    ...
    packages: [
      ...
      { label: '355 Diamonds', amount: 355, price: 295, originalPrice: 320 },
      { label: '610 Diamonds', amount: 610, price: 495, originalPrice: 530 },
      { label: '1090 Diamonds', amount: 1090, price: 885, originalPrice: 1040 },
      { label: '1720 Diamonds', amount: 1720, price: 1370, originalPrice: 2050 },
      { label: '2530 Diamonds', amount: 2530, price: 1970, originalPrice: 5100 },
      { label: 'Weekly', amount: 7, price: 195 },
      { label: 'Monthly', amount: 30, price: 970, originalPrice: 980 },
    ],
    inputFields: [
      {
        name: 'playerId',
