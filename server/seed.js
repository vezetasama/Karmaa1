...
const products = [
  {
    ...
    popularity: 95,
    packages: [
      { label: '100 Diamonds', amount: 100, price: 95 },
      { label: '310 Diamonds', amount: 310, price: 285, originalPrice: 320 },
      { label: '520 Diamonds', amount: 520, price: 470, originalPrice: 530 },
      { label: '1060 Diamonds', amount: 1060, price: 930, originalPrice: 1040 },
      { label: '2180 Diamonds', amount: 2180, price: 1860, originalPrice: 2050 },
      { label: '5600 Diamonds', amount: 5600, price: 4680, originalPrice: 5100 },
    ],
    inputFields: [
      {
        name: 'playerId',
  ...
  },
  {
    ...
    popularity: 90,
    packages: [
      { label: '60 UC', amount: 60, price: 120 },
      { label: '325 UC', amount: 325, price: 640, originalPrice: 700 },
      { label: '660 UC', amount: 660, price: 1240, originalPrice: 1380 },
      { label: '1800 UC', amount: 1800, price: 3360, originalPrice: 3650 },
      { label: '3850 UC', amount: 3850, price: 7050, originalPrice: 7600 },
      { label: '8100 UC', amount: 8100, price: 14400, originalPrice: 15200 },
    ],
    inputFields: [
      {
        name: 'playerId',
...
const seedDB = async () => {
  try {
    ...
    console.log('👤 Admin user created (admin@karma.com / admin123)');
    ...
    console.log('👤 Test user created (user@karma.com / user123)');
