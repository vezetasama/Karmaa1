...
const giftCardConfigs = {
  'google-play': {
    ...
    packages: [
       { label: '$5 Card', price: 875 },
      { label: '$10 Card', price: 1750 },
      { label: '$25 Card', price: 4375 },
      { label: '$50 Card', price: 8750 },
    ],
  },
  'itunes-apple': {
    name: 'iTunes / Apple',
  ...
  'steam-wallet': {
    ...
    packages: [
      { label: '$5 Wallet', price: 875 },
      { label: '$10 Wallet', price: 1750 },
      { label: '$20 Wallet', price: 3500 },
      { label: '$50 Wallet', price: 8750 },
    ],
  },
  playstation: {
    name: 'PlayStation',
    ...
    packages: [
      { label: '$10 Card', price: 1750 },
      { label: '$20 Card', price: 3500 },
      { label: '$50 Card', price: 8750 },
      { label: '$100 Card', price: 17500 },
    ],
  },
  xbox: {
    name: 'Xbox',
  ...
  netflix: {
    ...
    packages: [
      { label: '1 Month Standard', price: 350 },
      { label: '3 Months Standard', price: 1050 },
      { label: '6 Months Standard', price: 2100 },
      { label: '12 Months Standard', price: 4200 },
    ],
  },
  'razer-gold': {
    name: 'Razer Gold',
    ...
    packages: [
      { label: '$5 Pin', price: 875 },
      { label: '$10 Pin', price: 1750 },
      { label: '$25 Pin', price: 4375 },
      { label: '$50 Pin', price: 8750 },
      { label: '$100 Pin', price: 17500 },
    ],
  },
};
...
export default function GiftCardTopUp() {
  ...
  const validate = () => {
    ...
    if (!accountEmail.trim()) {
      nextErrors.accountEmail = `${config.codeType} is required`;
      showToast(`Please enter your ${config.codeType} first.`, 'error');
    }
