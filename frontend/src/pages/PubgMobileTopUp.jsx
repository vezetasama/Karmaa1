...
const packages = [
  { label: '60 UC', price: 150 },
  { label: '325 UC', price: 720, originalPrice: 700 },
  { label: '660 UC', price: 1480, originalPrice: 1380 },
  { label: '1800 UC', price: 3590, originalPrice: 3650 },
  { label: '3850 UC', price: 7180, originalPrice: 7600 },
  { label: '8100 UC', price: 14300, originalPrice: 15200 },
];
...
export default function PubgMobileTopUp() {
  ...
  const validate = () => {
    const nextErrors = {};
    if (!playerId.trim()) {
      nextErrors.playerId = 'Player ID is required';
