...
const packages = [
  ...
  { label: '355 Diamonds', price: 295, originalPrice: 320 },
  { label: '610 Diamonds', price: 495, originalPrice: 530 },
  { label: '1090 Diamonds', price: 885, originalPrice: 1040 },
  { label: '1720 Diamonds', price: 1370, originalPrice: 2050 },
  { label: '2530 Diamonds', price: 1970, originalPrice: 2470 },
  { label: 'Weekly', price: 195, icon: 'weekly' },
  { label: 'Monthly', price: 970, originalPrice: 980, icon: 'monthly' },
];
          ...
          {packages.map((p, i) => {
            ...
            return (
              <motion.button
                ...
                className={`relative p-4 rounded-xl border text-left transition-colors duration-300 ${isSelected ? selectedClass : 'bg-dark-900/40 border-white/[0.06] hover:border-white/[0.12]'
                  }`}
                id={`freefire-pkg-${i}`}
              >
                {PassIcon && theme ? (
                ...
                >
                  <span
                    className={`font-bold ${p.icon === 'weekly'
                      ? 'text-neon-cyan'
                      : p.icon === 'monthly'
                        ? 'text-neon-yellow'
                        : 'text-neon-cyan'
