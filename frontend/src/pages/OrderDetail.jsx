...
export default function OrderDetail() {
  ...
  const statusConfig = {
    ...
    completed: { icon: <CheckCircle className="w-4 h-4" />, class: 'badge-success', label: 'Completed', color: '#22C55E' },
    delivered: { icon: <CheckCircle className="w-4 h-4" />, class: 'badge-success', label: 'Completed', color: '#22C55E' },
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-dark-800/40 backdrop-blur-sm p-6">
            ...
            <div className="space-y-4">
              ...
              {(order.status === 'completed' || order.status === 'delivered') && order.deliveredAt && (
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-green-500/10 border border-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
