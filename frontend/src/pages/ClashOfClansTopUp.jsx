...
const packages = [
  { label: '80 Gems', price: 160 },
  { label: '500 Gems', price: 770, originalPrice: 850 },
  { label: '1200 Gems', price: 1490, originalPrice: 1650 },
  { label: '2500 Gems', price: 2890, originalPrice: 3250 },
  { label: '6500 Gems', price: 7290, originalPrice: 7950 },
  { label: '14000 Gems', price: 14450, originalPrice: 15800 },
];

export default function ClashOfClansTopUp() {
  ...
  const clashOfClansProduct = useMemo(
    () => ({
      _id: 'custom-clash-of-clans',
      name: 'Clash of Clans',
      slug: 'clash-of-clans',
      category: 'game-topup',
  ...
  const validate = () => {
    const nextErrors = {};
    if (!playerTag.trim()) {
      nextErrors.playerTag = 'Player Tag is required';
      showToast('Please enter your Player Tag first.', 'error');
    }
  ...
  const handleAddToCart = () => {
    ...
    if (!validate()) return;
    addItem(clashOfClansProduct, selectedPackage, { playerTag: playerTag.trim() });
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-8">
        <div className="lg:col-span-3 rounded-2xl border border-white/[0.06] bg-dark-800/40 backdrop-blur-sm overflow-hidden">
          <div className="relative h-56 sm:h-72">
            <img
              src="/images/topup-clash-of-clans.png"
              alt="Clash of Clans"
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
              ...
              <h1 className="text-2xl sm:text-3xl font-extrabold text-white mt-3 tracking-tight">Clash of Clans Top Up</h1>
        ...
        <div className="lg:col-span-2 rounded-2xl border border-white/[0.06] bg-dark-800/40 backdrop-blur-sm p-6">
          ...
          <div className="mt-5 p-4 rounded-xl bg-dark-900/40 border border-white/[0.06]">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Open Clash of Clans, tap your profile in-game, and copy the tag shown under your village name.
            </p>
          </div>
        </div>
      </div>
