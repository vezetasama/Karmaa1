...
export const getGuestOrders = (orderIds) => api.post('/orders/guest', { orderIds });
...
export const updateOrderStatus = (id, status, giftCardCode) => api.put(`/admin/orders/${id}/status`, { status, giftCardCode });
...
export const clearAdminTransactionalData = () =>
  api.delete('/admin/data/transactional', { data: { confirm: 'CLEAR_ALL_ORDERS' } });
