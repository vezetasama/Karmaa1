          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-[68px]">
              ...
              <div className="hidden md:flex items-center gap-1">
                ...
                {/* My Orders / Dashboard icon (for all users including guests) */}
                <Link to="/dashboard" className="nav-icon-btn" id="nav-dashboard" title="My Orders">
                ...
                {user ? (
                  ...
                  <>
                    <div className="nav-separator" />
                    <Link to="/register" className="nav-cta-filled" id="nav-register">
                      Sign Up
                    </Link>
                  </>
                )}
