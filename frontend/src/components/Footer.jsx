...
export default function Footer() {
  // ─── EDIT LOGO STYLE HERE ───
  const logoSettings = {
    width: "96px",       // Width of the logo (e.g. "94px", "90px")
    height: "72px",      // Height of the logo (e.g. "78px", "90px")
    shiftRight: "4px",   // Shift the logo to the right (e.g. "22px", "30px", "5px")
  };
    ...
    <footer className="relative mt-auto overflow-hidden border-t border-white/[0.04]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        <div className="grid grid-cols-3 md:grid-cols-4 gap-6 sm:gap-12">
          ...
          {/* Brand */}
          <div className="hidden sm:flex col-span-3 md:col-span-1 flex-col gap-3 sm:gap-4">
            <Link
              to="/"
              className="flex items-center group shrink-0"
              style={{ marginLeft: logoSettings.shiftRight }}
            >
              <img
            ...
            <p className="hidden sm:block text-xs sm:text-sm text-gray-500 leading-relaxed max-w-[260px]">
